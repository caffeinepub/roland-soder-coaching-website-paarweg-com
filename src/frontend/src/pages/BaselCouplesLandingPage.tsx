...
export default function BaselCouplesLandingPage() {
  ...
  useEffect(() => {
    document.title =
      "Paarberatung Basel – Professionelle Paartherapie | PaarWeg";
    ...
    metaDescription.setAttribute(
      "content",
      "Paarberatung in Basel: Professionelle Unterstützung für Paare in Krisen, bei Kommunikationsproblemen und Konflikten. Jetzt kostenloses Kennenlerngespräch buchen.",
    );
    ...
    const ogTags = [
      { property: "og:title", content: "Paarberatung Basel – PaarWeg" },
      {
        ...
        content:
          "Professionelle Paarberatung in Basel. Kostenloses Kennenlerngespräch buchen.",
      },
      {
        property: "og:url",
