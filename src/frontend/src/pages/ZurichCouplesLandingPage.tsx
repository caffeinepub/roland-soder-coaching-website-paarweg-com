...
export default function ZurichCouplesLandingPage() {
  ...
  useEffect(() => {
    document.title =
      "Paarberatung Zürich – Professionelle Paartherapie | PaarWeg";
    ...
    metaDescription.setAttribute(
      "content",
      "Paarberatung in Zürich: Professionelle Unterstützung für Paare in Krisen, bei Kommunikationsproblemen und Konflikten. Jetzt kostenloses Kennenlerngespräch buchen.",
    );
    ...
    const ogTags = [
      { property: "og:title", content: "Paarberatung Zürich – PaarWeg" },
      {
        ...
        content:
          "Professionelle Paarberatung in Zürich. Kostenloses Kennenlerngespräch buchen.",
      },
      {
        property: "og:url",
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-4">
              Viele Paare stehen irgendwann an einem Punkt, an dem Gespräche
              eskalieren, Schweigen überwiegt oder die Verbindung unsicher
              geworden ist.
            </p>
            <p className="text-lg text-muted-foreground mb-4">
              In dieser Phase geht es nicht immer darum, etwas
              „wiederherzustellen", sondern darum, Klarheit zu gewinnen.
            </p>
            <p className="text-lg text-muted-foreground mb-8">
              Als erfahrener Paarberatungscoach begleite ich Sie dabei, Ihre
              Situation offen zu betrachten, Muster zu verstehen und eine
              bewusste Entscheidung für Ihren weiteren Weg zu treffen –
              respektvoll, strukturiert und auf Augenhöhe.
            </p>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              {
                icon: Phone,
                text: "Ein konkreter Auslöser (Vertrauensbruch, Krise) belastet die Beziehung",
              },
            ].map(({ icon: Icon, text }) => (
              <div
                key={text}
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={step}
                className="flex flex-col items-center text-center p-6 rounded-2xl bg-background border border-border shadow-sm"
              >
