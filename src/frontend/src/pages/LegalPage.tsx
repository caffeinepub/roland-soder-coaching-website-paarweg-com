              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    werden. Als Diensteanbieter bin ich für eigene Inhalte auf
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    auf diesen Seiten unterliegen dem Schweizer Urheberrecht.
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <p className="mb-3 text-sm text-muted-foreground">
                    ...
                    die Sie uns per E-Mail oder Telefon mitteilen.
                  </p>
                  <p className="mb-3 text-sm text-muted-foreground">
                ...
                <div>
                  ...
                  <p className="mb-3 text-sm text-muted-foreground">
                    ...
                    von Anschlussfragen bei uns gespeichert. Diese Daten geben
                  ...
                  <p className="text-sm text-muted-foreground">
                    Die von Ihnen mitgeteilten Daten verbleiben bei uns, bis Sie
                ...
                <div>
                  ...
                  <p className="mb-3 text-sm text-muted-foreground">
                    Diese Cookies sind für den Betrieb der Website technisch
                    notwendig und können nicht deaktiviert werden. Sie werden in
                    der Regel nur als Reaktion auf von Ihnen getätigte Aktionen
                    gesetzt, die einer Dienstanforderung entsprechen, wie etwa
                    dem Festlegen Ihrer Datenschutzeinstellungen, dem Anmelden
                  ...
                  <p className="mb-3 text-sm text-muted-foreground">
                    ...
                    Website interagieren, indem Informationen anonym gesammelt
                    und gemeldet werden. Diese Cookies werden nur mit Ihrer
                    Zustimmung gesetzt.
                  </p>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Diese Cookies werden verwendet, um Besuchern auf Webseiten
                    zu folgen. Die Absicht ist, Anzeigen zu zeigen, die relevant
                    und ansprechend für den einzelnen Benutzer sind. Diese
                    Cookies werden nur mit Ihrer Zustimmung gesetzt.
                  </p>
                </div>
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    Coaching-Leistungen von Roland Soder Coaching. Mit der
                    Buchung eines Termins oder der Inanspruchnahme einer
                    Leistung erkennen Sie diese AGB an.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mb-3 text-sm text-muted-foreground">
                    Das Coaching umfasst die Begleitung von Einzelpersonen und
                    Paaren in Fragen der persönlichen und partnerschaftlichen
                    Entwicklung. Die konkreten Inhalte und der Umfang werden
                    individuell vereinbart.
                  </p>
                  <p className="mb-3 text-sm text-muted-foreground">
                    <strong>Wichtig:</strong> Coaching ist keine Psychotherapie
                    und kein Ersatz für eine solche. Coaching richtet sich an
                    psychisch gesunde Menschen, die an ihrer persönlichen oder
                    partnerschaftlichen Entwicklung arbeiten möchten.
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Bei psychischen Erkrankungen, akuten Krisen,
                    Suchtproblematiken oder traumatischen Erfahrungen wird die
                    Inanspruchnahme therapeutischer oder ärztlicher Hilfe
                    empfohlen. Der Coach ist nicht berechtigt, Diagnosen zu
                    stellen oder Therapien durchzuführen.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mb-3 text-sm text-muted-foreground">
                    ...
                    Bei Verhinderung ist eine Absage bis spätestens 12 Stunden
                    vor dem vereinbarten Termin erforderlich.
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Bei späterer Absage oder Nichterscheinen ohne wichtigen
                    Grund wird das volle Honorar fällig. Als wichtiger Grund
                    gelten unvorhersehbare Ereignisse wie akute Erkrankung (mit
                    ärztlichem Attest) oder andere außergewöhnliche Umstände.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mb-3 text-sm text-muted-foreground">
                    Das Honorar wird individuell vereinbart und ist nach jeder
                    Sitzung fällig, sofern keine andere Vereinbarung getroffen
                    wurde. Die Zahlung erfolgt per Rechnung.
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Das Erstgespräch (60 Minuten) kostet 60 CHF und dient dem
                    gegenseitigen Kennenlernen sowie der Klärung Ihres
                    Anliegens.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mb-3 text-sm text-muted-foreground">
                    Alle Inhalte der Coaching-Sitzungen werden streng
                    vertraulich behandelt. Eine Weitergabe von Informationen an
                    Dritte erfolgt nur mit ausdrücklicher Zustimmung des
                    Klienten oder bei gesetzlicher Verpflichtung (z.B. bei
                    konkreter Gefahr für Leib und Leben).
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Der Coach unterliegt keiner gesetzlichen Schweigepflicht wie
                    Ärzte oder Psychotherapeuten, verpflichtet sich aber zur
                    Verschwiegenheit über alle ihm anvertrauten Informationen.
                  </p>
                </div>
                ...
                <div>
                  <h3 className="mb-3 font-semibold">
                    6. Eigenverantwortung des Klienten
                  </h3>
                  <p className="mb-3 text-sm text-muted-foreground">
                    Der Klient trägt die Verantwortung für seine Entscheidungen
                    und Handlungen. Der Coach gibt Impulse, stellt Fragen und
                    begleitet Prozesse, trifft aber keine Entscheidungen für den
                    Klienten.
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Der Klient verpflichtet sich, den Coach über relevante
                    gesundheitliche oder psychische Einschränkungen zu
                    informieren, die für das Coaching von Bedeutung sein
                    könnten.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mb-3 text-sm text-muted-foreground">
                    Die Haftung für Schäden, die aus der Coaching-Tätigkeit
                    entstehen, ist auf Vorsatz und grobe Fahrlässigkeit
                    beschränkt. Eine Haftung für den Erfolg des Coachings wird
                    nicht übernommen.
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Der Coach haftet nicht für Entscheidungen und Handlungen des
                    Klienten, die dieser aufgrund oder während des Coachings
                    trifft.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    Bereits vereinbarte und bezahlte Termine werden nach den
                    Regelungen unter Punkt 3 behandelt.
                  </p>
                </div>
