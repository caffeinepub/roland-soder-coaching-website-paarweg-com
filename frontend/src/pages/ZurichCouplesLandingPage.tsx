...
export default function ZurichCouplesLandingPage() {
  ...
  // SEO meta tags
  useEffect(() => {
    document.title = 'Paarberatung Zürich – Professionelle Paartherapie | PaarWeg';
    ...
    metaDescription.setAttribute('content', 'Paarberatung in Zürich: Professionelle Unterstützung für Paare in Krisen, bei Kommunikationsproblemen und Konflikten. Jetzt kostenloses Kennenlerngespräch buchen.');
