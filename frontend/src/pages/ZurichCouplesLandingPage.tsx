...
import { ArrowRight, Heart, MessageCircle, Users2, CheckCircle2, Play, Pause, Volume2, VolumeX } from 'lucide-react';
...
export default function ZurichCouplesLandingPage() {
  ...
  // Google Tag – scoped to Zürich page only
  useEffect(() => {
    ...
    return () => {
      // Clean up when leaving the Zürich page
      ...
      <section className="bg-gradient-to-br from-primary/10 via-accent/10 to-muted/20 py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-8 text-lg text-muted-foreground">
              Ein unverbindliches Erstgespräch gibt Ihnen die Möglichkeit, mich kennenzulernen und zu spüren, 
              ob die Zusammenarbeit für Sie passt. Ohne Druck, ohne Verpflichtung.
            </p>
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
              <Button asChild size="lg" className="text-base">
                <a
