    ...
    const checkDomainFile = async () => {
      try {
        ...
        if (trimmedContent === "www.paarweg.com") {
          ...
          setErrorMessage(
            `Unexpected content: "${trimmedContent}". Expected: "www.paarweg.com"`,
          );
        }
      } catch (error) {
        setVerificationStatus("error");
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-2xl">
              Internet Computer Domain Verification
            </CardTitle>
            <CardDescription>
              ...
              <div className="space-y-2 text-sm">
                <div className="p-3 bg-muted/30 rounded">
                  <p className="font-medium mb-1">
                    1. frontend/public/.well-known/ic-domains
                  </p>
                  <p className="text-muted-foreground">
                    Datei ohne Erweiterung mit Inhalt:{" "}
                ...
                <div className="p-3 bg-muted/30 rounded">
                  ...
                  <p className="text-muted-foreground">
                    Konfiguration:{" "}
                    <code className="bg-background px-1 rounded">{`[{ "match": ".well-known", "ignore": false }]`}</code>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-800">
                <p className="text-sm mb-2">
                  Die Datei sollte öffentlich zugänglich sein unter:
                </p>
                <a
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li className="flex gap-2">
                  <span className="text-primary">•</span>
                  <span>
                    Die Datei muss den exakten Inhalt{" "}
                    <code className="bg-background px-1 rounded">
                      www.paarweg.com
                    </code>{" "}
                    enthalten (ohne Leerzeichen am Ende)
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-primary">•</span>
                  <span>
                    ...
                    Datei muss das .well-known Verzeichnis inkludieren
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-primary">•</span>
                  <span>
                    Nach dem Deployment sollte die URL öffentlich zugänglich
                    sein und den Plain-Text-Inhalt zurückgeben
                  </span>
                </li>
              </ul>
            </div>
