...
export default function TechnicalStatusPage() {
  ...
  const checkCSRGenerator = (): StatusCheck => {
    try {
      return {
        ...
        details:
          "Die CSR-Generator-Seite ist unter /admin/csr-generator erreichbar.",
      };
    } catch (_error) {
      return {
        name: "CSR-Generator",
  ...
  const checkDomainResolution = async (): Promise<StatusCheck> => {
    try {
      ...
      if (hostname.includes("caffeine.xyz")) {
        return {
          name: "Domain-Auflösung",
          status: "warning",
        ...
        <div className="container mx-auto px-4 py-16 md:px-6 md:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Vollständige Überprüfung der Live-Setup-Konfiguration für
              paarweg.com
            </p>
          </div>
        </div>
          ...
          <div className="mx-auto max-w-4xl space-y-8">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <div className="space-y-1 text-sm text-muted-foreground">
                    ...
                    <p>
                      • Root-Domain: paarweg.com → 301-Weiterleitung zu
                      www.paarweg.com
                    </p>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Nützliche Links für die Verwaltung
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-2">
                ...
                <Button
                  ...
                  className="w-full justify-start"
                  onClick={() =>
                    window.open("https://www.united-domains.de", "_blank")
                  }
                >
                ...
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      "https://plausible.io/www.paarweg.com",
                      "_blank",
                    )
                  }
                >
